...
if __name__ == "__main__":
    ...
    # Add sliding window and eval mode arguments
    parser.add_argument("--window_size", type=int, default=50, help="Sliding window size for backend optimization")
    parser.add_argument("--stride", type=int, default=25, help="Stride for sliding window")
    parser.add_argument("--batch_size", type=int, default=10, help="Batch size for feature extraction in trajectory filler")
    parser.add_argument("--eval_mode", type=str, default="full_ba", choices=["full_ba", "keyframe_ba"], help="Evaluation mode")
    ...
    metric_depth_paths = sorted(glob.glob(glob_path))
    ...
    if args.eval_mode == "full_ba":
        eval_kwargs["full_ba"] = True
    else:
        eval_kwargs["full_ba"] = False
